From Extraction.L.Functions Require Export Eval.
...
Proof.
  ...
  -eapply Seval.eval_converges. unfold Por. Lsimpl. rewrite R. Lsimpl. Lreflexivity.
Qed.
...
Proof.
  ...
  -exists (doesHaltIn s n). subst. unfold Por. Lsimpl. rewrite C'. now Lsimpl. 
  -eexists. now Lsimpl.
Qed.
